...
import { Typography, Switch, FormControlLabel, TextField, Button, Divider, Select, MenuItem, FormControl, InputLabel, Box } from '@mui/material';
...
const Settings = ({ isDarkMode, saveTheme, settings, setSettings, onSave }) => {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      <SettingsPanel elevation={3} sx={{ flex: 1, marginBottom: '8px' }}>
      ...
      <Box sx={{ padding: '8px 16px', backgroundColor: 'background.paper', borderTop: '1px solid', borderColor: 'divider' }}>
        <Button 
          onClick={onSave} 
          variant="contained" 
          color="primary"
